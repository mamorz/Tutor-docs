...
/**
 * Class representing show stats command.
 * @author upgcv
 */
public class ShowStatsCommand implements Command<Competition> {
    ...
    public Result execute(Competition handle) {
        ...
        return Result.success(handle.getMonsterOnTurn().getShowStatsInfo());
    }
}
